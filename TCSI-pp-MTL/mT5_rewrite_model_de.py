...
savepath=f"./result/mt5_rewrite_de_epoch{max_epochs}.ckpt" #save model
save_rewrite_path=f'./result/mt5_rewrite_de_epoch{max_epochs}.json' #save rewrite result
...
#     print(name, param.requires_grad)
if train_is_ture:
    # trainer = pl.Trainer(max_epochs=max_epochs, amp_level='01', gpus=3, progress_bar_refresh_rate=30)
