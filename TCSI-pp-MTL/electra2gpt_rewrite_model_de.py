...
savepath=f"/root/autodl-tmp/electra2gpt_ddp2_rewrite_epoch{num_epoch}.ckpt" #save model
save_rewrite_path=f'/root/autodl-tmp/electra2gpt_ddp2_rewrite_epoch{num_epoch}.json' #save rewrite result
