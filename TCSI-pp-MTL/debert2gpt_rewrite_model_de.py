...
xlnet2gpt_model = EncoderDecoderModel.from_encoder_decoder_pretrained('microsoft/deberta-v3-base', "openai-community/gpt2")
...
savepath=f"/root/autodl-tmp/debert2gpt_rewrite_epoch{num_epoch}.ckpt" #save model
save_rewrite_path=f'/root/autodl-tmp/debert2gpt_rewrite_epoch{num_epoch}.json' #save rewrite result
