...
bert_tokenizer = BertTokenizer.from_pretrained('nghuyong/ernie-2.0-base-en')
bert_tokenizer.bos_token = bert_tokenizer.cls_token
bert_tokenizer.eos_token = bert_tokenizer.sep_token
gpt2_tokenizer =BertTokenizerFast.from_pretrained("google-bert/bert-base-cased")
gpt2_tokenizer.bos_token = gpt2_tokenizer.cls_token
gpt2_tokenizer.eos_token = gpt2_tokenizer.sep_token
ernie2gpt_model = EncoderDecoderModel.from_encoder_decoder_pretrained('nghuyong/ernie-2.0-base-en', "google-bert/bert-base-cased")
