...
class Config(object):
    ...
    def __init__(self, dataset):
        ...
        self.bert_path = 'microsoft/deberta-v3-base'
...
class Model(nn.Module):
    def __init__(self, config):
        ...
        self.bert = DebertaV2Model.from_pretrained(config.bert_path, ignore_mismatched_sizes=True)
