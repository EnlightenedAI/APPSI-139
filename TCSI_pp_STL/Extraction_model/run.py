...
# try:
#     response = requests.get('https://huggingface.co/', timeout=50)
...
if __name__ == '__main__':
    ...
    if not args.test:
        ...
        # if args.test=='*'
        # model.load_state_dict(torch.load('TCSI_pp/Extraction_model/model_save/saved_distilbert_hugging_dict_class12 .ckpt&'))
